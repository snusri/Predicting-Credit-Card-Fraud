...
print"Percentage of secure transaction: " + str(y_sel_len*100/len(selected_records)) + "%"

print"Percentage of fradulent transactions: ", str(x_sel_len*100/len(selected_records)) + "%"
